...
class _TansiyonGrafikState extends State<TansiyonGrafik> {
  ...
  Future<List<OlcumDegerleri>> verileriCek(String sinirlama) async{
    ...
    String butunDegerler = "SELECT * FROM test_bloodpressure ORDER BY date";
    String hafta1 = "SELECT * FROM test_bloodpressure WHERE date >= DATE_SUB(NOW(), INTERVAL 1 WEEK) ORDER BY date DESC";
    String hafta2 = "SELECT * FROM test_bloodpressure WHERE date >= DATE_SUB(NOW(), INTERVAL 2 WEEK) ORDER BY date DESC";
    String hafta3 = "SELECT * FROM test_bloodpressure WHERE date >= DATE_SUB(NOW(), INTERVAL 3 WEEK) ORDER BY date DESC";
    String ay1 = "SELECT * FROM test_bloodpressure WHERE date >= DATE_SUB(NOW(), INTERVAL 1 MONTH) ORDER BY date DESC";
