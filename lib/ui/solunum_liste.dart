...
class _SolunumListeState extends State<SolunumListe> {
  ...
  Future<List<OlcumDegerleri>> verileriCek(String sinirlama) async{
    ...
    String butunDegerler = "SELECT * FROM res_value ORDER BY timestamp";
    String hafta1 = "SELECT * FROM res_value WHERE timestamp >= DATE_SUB(NOW(), INTERVAL 1 WEEK)";
    String hafta2 = "SELECT * FROM res_value WHERE timestamp >= DATE_SUB(NOW(), INTERVAL 2 WEEK)";
    String hafta3 = "SELECT * FROM res_value WHERE timestamp >= DATE_SUB(NOW(), INTERVAL 3 WEEK)";
    String ay1 = "SELECT * FROM res_value WHERE timestamp >= DATE_SUB(NOW(), INTERVAL 1 MONTH)";
